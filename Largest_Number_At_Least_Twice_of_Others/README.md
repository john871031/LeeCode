<div class="_1l1MA" data-track-load="qd_description_content"><p>You are given an integer array <code>nums</code> where the largest integer is <strong>unique</strong>.</p>
