<div class="_1l1MA" data-track-load="qd_description_content"><p>You are keeping the scores for a baseball game with strange rules. At the beginning of the game, you start with an empty record.</p>
