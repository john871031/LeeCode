<div class="xFUwe" data-track-load="description_content"><p>An <strong>additive number</strong> is a string whose digits can form an <strong>additive sequence</strong>.</p>
