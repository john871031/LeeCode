<div class="xFUwe" data-track-load="description_content"><p>A <strong>super ugly number</strong> is a positive integer whose prime factors are in the array <code>primes</code>.</p>
