<div class="_1l1MA" data-track-load="qd_description_content"><p>A <strong>self-dividing number</strong> is a number that is divisible by every digit it contains.</p>
